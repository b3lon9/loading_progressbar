...
typedef LoadingProgressbarEventFunction = Function(LoadingProgressbarEvent event, bool visible, int progress);
typedef LoadingProgressbarAnimatedEndEventFunction = Function(bool visible, int progress);
